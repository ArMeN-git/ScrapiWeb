...
namespace WebScrapingUI.Models
{
    ...
    public class SetPasswordViewModel
    {
        ...
        [DataType(DataType.Password)]
        [Display(Name = "ConfirmNew", ResourceType = typeof(Account))]
        [Compare("NewPassword", ErrorMessageResourceType = typeof(Account), ErrorMessageResourceName = "PassMatch")]
    ...
    public class AddPhoneNumberViewModel
    {
        [Required]
        [Phone]
        [Display(Name = "Phone", ResourceType = typeof(Account))]
